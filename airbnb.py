...
st.set_page_config(page_title="AirBnb-Analysis by Dinesh Ravi !!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r'C:\Users\DINESH RAVI\PycharmProjects\Airbnb Analysis')
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Dinesh Ravi"}')
    mail = (f'{"Mail :"}  {"dineshr9599@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/dineshravi9599",
        "LINKEDIN": "https://www.linkedin.com/in/dinesh-ravi-39b68915a/"}

    col1, col2 = st.columns(2)
    col1.image(Image.open(r"C:\Users\DINESH RAVI\Desktop\air bnb\Airbnb-logo.webp"), width=300)
